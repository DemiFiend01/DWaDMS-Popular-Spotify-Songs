...
DROP TABLE IF EXISTS track_streams_1B_10B;
DROP TABLE IF EXISTS track_streams_500M_1B;
DROP TABLE IF EXISTS track_streams_100_500M;
DROP TABLE IF EXISTS track_streams_1M_100M;
DROP TABLE IF EXISTS track_streams_0_1M;
